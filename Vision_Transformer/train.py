...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str,
                        default="../../autodl-tmp/dataset/flowers/flower_photos")
    parser.add_argument('--model-name', default='', help='create model name')

    # 预训练权重路径，如果不想载入就设置为空字符
    parser.add_argument('--weights', type=str, default='../../autodl-tmp/PredWeights/jx_vit_base_patch16_224_in21k-e5005f0a.pth',
    ...
    parser.add_argument('--wandb_name', type=str, default='ViT-0',
                        help='name of current training procedure of wandb')
    parser.add_argument('--description', type=str, default='Add reconstruction Loss, Unfreeze ResNet backbone.',
